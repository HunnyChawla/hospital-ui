...
# =============================================================================
# Docker Build Script for TV Legacy Display
# =============================================================================
...
#   DOCKERHUB_IMAGE     - Image name (default: tv-legacy-display)
...
IMAGE_NAME="${DOCKERHUB_IMAGE:-tv-legacy-display}"
...
OPTIONS:
    ...
    --image=NAME        Image name (default: tv-legacy-display)
...
do_build() {
    ...
    # --pull ensures we always get the latest base images (node:20-alpine)
    ...
    case $CACHE_MODE in
        registry)
            ...
            ;;
        local)
            local cache_dir="${TMPDIR:-/tmp}/.buildx-cache-tv-legacy"
    ...
    # Metadata arguments
    cmd+=" --build-arg APP_VERSION=${version:-1.0.0}"
...
main() {
    ...
    echo ""
    echo "═══════════════════════════════════════════════════════════════"
    echo "  TV Legacy Display - Docker Build Script"
    echo "═══════════════════════════════════════════════════════════════"
    echo ""
