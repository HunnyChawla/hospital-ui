...
const vaOptions: VAOption[] = [
  ...
  { value: "6/6 p", label: "6/6 p (6/6 Partial)", isCommon: true },
  { value: "6/5", label: "6/5 (Better than normal)", isCommon: false },
  { value: "6/9", label: "6/9", isCommon: true },
  { value: "6/9 p", label: "6/9 p", isCommon: false },
  { value: "6/12", label: "6/12", isCommon: true },
  { value: "6/12 p", label: "6/12 p", isCommon: false },
  { value: "6/18", label: "6/18", isCommon: true },
  { value: "6/18 p", label: "6/18 p", isCommon: false },
  { value: "6/24", label: "6/24", isCommon: false },
  { value: "6/24 p", label: "6/24 p", isCommon: false },
  { value: "6/36", label: "6/36", isCommon: true },
  { value: "6/36 p", label: "6/36 p", isCommon: false },
  { value: "6/60", label: "6/60", isCommon: true },
  { value: "6/60 p", label: "6/60 p", isCommon: false },
  ...
  { value: "PR+", label: "PR+ (Projection of Rays Accurate)", isCommon: false },
  { value: "PR-", label: "PR- (Projection of Rays Inaccurate)", isCommon: false },
  { value: "PL+ PR+", label: "PL+ PR+ (Light Perception & Projection Accurate)", isCommon: false },
  { value: "PL+ PR-", label: "PL+ PR- (Light Perception Present, Projection Inaccurate)", isCommon: false },
