...
import { CheckCircle2, ShieldCheck, UserPlus, Copy, Check, RefreshCw } from "lucide-react";
      ...
      <div className="inline-flex items-center gap-1.5">
        ...
        {showSyncButton && onSyncClick && (
          <button
            type="button"
            onClick={onSyncClick}
            className={`inline-flex items-center gap-1 rounded-full border border-emerald-300 bg-emerald-50 font-medium text-emerald-700 hover:bg-emerald-100 transition-colors ${
