    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <p className="mt-1 text-[11px] text-slate-400">Normal: 120/80 mmHg</p>
        </div>

        {/* Pulse Rate */}
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-semibold">Heart / Pulse Rate</span>
          ...
          <p className="mt-1 text-[11px] text-slate-400">Normal: 60 - 100 bpm</p>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <p className="mt-1 text-[11px] text-slate-400">Normal: 97.8 - 99.1 °F</p>
        </div>

        {/* Oxygen Saturation */}
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-semibold">SpO₂</span>
          ...
          <p className="mt-1 text-[11px] text-slate-400">Normal: 95 - 100%</p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-slate-100 pb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-slate-900">Vitals Recorded During Admission</h3>
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-rose-600 to-pink-600 px-4 py-2 text-xs font-bold text-white shadow-sm transition hover:shadow"
          >
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 p-4 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl animate-in fade-in zoom-in-95 duration-150 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleRecordVitalsSubmit} className="mt-4 space-y-4 text-xs">
              <div>
              ...
              <div className="flex justify-end gap-2 border-t border-slate-100 pt-3">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="rounded-xl bg-gradient-to-r from-rose-600 to-pink-600 px-5 py-2 text-xs font-bold text-white shadow-sm hover:shadow disabled:opacity-50"
                >
