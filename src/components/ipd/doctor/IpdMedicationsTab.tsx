    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-slate-100 pb-3">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 px-4 py-2 text-xs font-bold text-white shadow-sm transition hover:shadow"
          >
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
          ...
          <div>
            <h3 className="font-bold text-slate-900">Discontinued / Past Medications</h3>
            <p className="text-xs text-slate-500">
          ...
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl animate-in fade-in zoom-in-95 duration-150 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-slate-900">Prescribe IPD Medication</h3>
              </div>
              <button
            ...
            <form onSubmit={handleAddMedicationSubmit} className="mt-4 space-y-4 text-xs">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Type to search or enter brand/generic name (e.g. Ceftriaxone, Pantoprazole)..."
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g. 1 g, 40 mg, 650 mg"
                    value={dose}
              ...
              <div className="flex justify-end gap-2 border-t border-slate-100 pt-3">
                ...
                <button
                  ...
                  className="rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 px-5 py-2 text-xs font-bold text-white shadow-sm hover:shadow disabled:opacity-50"
                >
          ...
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl animate-in fade-in zoom-in-95 duration-150">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2 text-rose-600">
                ...
                <h3 className="font-bold text-slate-900">Stop Medication</h3>
              </div>
              <button
            ...
            <form onSubmit={handleStopMedicationSubmit} className="mt-4 space-y-4 text-xs">
              ...
              <div className="flex justify-end gap-2 border-t border-slate-100 pt-3">
                ...
                <button
                  ...
                  className="rounded-xl bg-rose-600 px-5 py-2 text-xs font-bold text-white shadow-sm hover:bg-rose-700 disabled:opacity-50"
                >
